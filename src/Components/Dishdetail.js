...
export class CommentForm extends Component{
    ...
    toggleModals(){
        this.setState({
            isModalsOpen : !this.state.isModalsOpen
        });
    }
    ...
    render() {
        return (
            ...
            <div>
                <Button outline onClick={this.toggleModals}>
                    <span className='fa fa-edit fa-lg'></span>Submit Comment
                </Button>
                
                
                <Modal isOpen={this.state.isModalsOpen} toggle={this.toggleModals}>
                    <ModalHeader toggle={this.toggleModals}>Submit Comment</ModalHeader>
                    <ModalBody>
